...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		view = glm::rotate(view, glm::radians(rot), glm::vec3(1.0f, 0.0f, 0.0f)); // X
		view = glm::rotate(view, glm::radians(rotY), glm::vec3(0.0f, 1.0f, 0.0f)); // Y
		view = glm::rotate(view, glm::radians(rotZ), glm::vec3(0.0f, 0.0f, 1.0f)); // Z
