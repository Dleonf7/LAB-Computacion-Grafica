...
int main()
{
	...
	image = stbi_load("images/window.png", &textureWidth, &textureHeight, &nrChannels, 0); //SE AGREGA VENTANA
	glBindTexture(GL_TEXTURE_2D, texture1);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, textureWidth, textureHeight, 0, GL_RGBA, GL_UNSIGNED_BYTE, image); //RGBA para la ventana
