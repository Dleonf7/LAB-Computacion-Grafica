...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		color = glm::vec3(1.0f, 1.0f, 1.0f); //Mano blanca
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);//A
		...
		modelTemp2 = modelTemp; //Base de la mano
		...
		//Falange A
		model = glm::translate(modelTemp2, glm::vec3(0.35f, 0.35f, 0.0f));
		...
		//Falange A
		model = glm::translate(modelTemp2, glm::vec3(0.35f, 0.0f, 0.0f));
		modelTemp = model = glm::translate(model, glm::vec3(0.3f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.6f, 0.2f, 0.2f));
